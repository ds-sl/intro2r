...
1. Choose _New Project_ from File menu.
  - You need to save files if are working with an other project.
...
Install `WDI` package for the first time. See [the Setup Section Above](#intro:setup).
