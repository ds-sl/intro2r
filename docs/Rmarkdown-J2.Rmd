...
```{r include=FALSE, eval=FALSE}
  - \setCJKmainfont{Hiragino Mincho Pro} # for Mac if you prefer Hiragino
or 
  - \setCJKmainfont{HiraMaruProN-W4}
or
  - \setCJKmainfont{Osaka}
  - \setCJKsansfont{Osaka-Mono}
  - \setCJKmonofont{Osaka-Mono}
# possible to replace the following with above
