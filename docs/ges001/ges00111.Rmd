...
01/23(TU)　Rでデータサイエンス5　 [[Main](https://ds-sl.github.io/intro2r/ges001/)]
...
-   引用符が入っていなかったり、== のところが、= だったり、いろいろな可能性があります。Error message を読むこともたいせつです。エラーがでた、Code Chunk と、Error message を、ChatGPT や、Google Search に入れると、解決方法を教えてくれることもあります。
...
*スライドで見ている方は、RNotebook ファイルで見てください* [[リンク](https://ds-sl.github.io/intro2r/ges001/ges00111.nb.html)]
