...
GDP per capita, PPP (constant 2017 international \$) とか、Population, total を、指標名（Indicator Name）といい、NY.GDP.PCAP.PP.KD とか、SP.POP.TOTL を、指標コード（Indicator Code）と言います。後者を、WDI（世界開発指標、World Development Indicator）と呼ぶこともあります。
...
-   図1から図7 でわからなかったことで、どのようなことが知りたいですか。
