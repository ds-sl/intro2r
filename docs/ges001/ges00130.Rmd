...
-   WDI の指標数: 1,486、最大217カ国、79地域のデータ
-   国および年によっては、いくつかの指標のデータが提供されていません。
...
**オープンデータを活用**し、情報の透明性を高くしていきましょう。

## おわりに

-   **「日本ごと・世界ごと・自分ごと」 「自分ごと・世界ごと・日本ごと」**

    -   自分が生きている社会の課題　vs 普遍的な人間の課題 vs 自分や個人の課題

    -   自分や個人の課題　vs 普遍的な人間の課題 vs 自分が生きている社会の課題

**オープンデータは、通常は困難な「世界ごと」として課題を相対化、普遍化する。**

-   **今だけ、金だけ、自分だけ**（単純化バイアス）にとらわれない生き方
    -   遺伝子的情報の中に自己防衛本能として書き込まれているかもしれない
    -   思考しているその時、見えやすい価値、自分の経験だけに縛られずより広い視点へ

**制約条件を弱めることで、より（個別の課題だけではない）普遍的な、継続性もある、解決方法の緒（いとぐち clue）がみつかることがある**

## おわりに（つづき）：AI とどう付き合っていくか

-   **探究的データ分析**：得られた結論に満足せず、探求し続けることを厭わないで

    -   分断ではなく、公開・共有・議論・協働によって、他者の視点をたいせつに

    -   課題は相互に複雑に関係し合っているが、データ（情報）も膨大にある。

    -   特定の行動の決断が正しいか間違っているかで争うより、行動しながら、その影響を図りながら、修正していくことがたいせつ。施策の影響は、実行してみないとわからない部分もある。

-   AI の最大の強みは、**学び続けること**

    -   AI の影響が大きくなっていく時代に、AIと上手に付き合うには、AI の思考方法（データサイエンス）を自分も経験し、コミュニケーションしましょう。

    -   さまざまなひとへの影響を、丁寧に測定し、AI とともに考えましょう。
