...
01/09(TU)　Rでデータサイエンス3：GNI係数と所得分布
...
01/16(TU)　Rでデータサイエンス4:貧困（データが少ない難点）
...
02/06 (TU)　Rでデータサイエンス7：都市部と農村部の生活状況の格差
