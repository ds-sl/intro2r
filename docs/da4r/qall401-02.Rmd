...
The data `iris` is a part of the preinstalled package `datasets.` [[Link](https://en.wikipedia.org/wiki/Iris_flower_data_set)]
...
Types: Current values are the vector types `"logical"`, `"integer"`, `"double"`, `"character"`, `"list"`, etc.

-   class(df_iris): class of `df_iris` is a "data.frame"

-   class(df_iris[5]): "data.frame"

-   class(df_iris[[5]]): "factor"

-   typeof(df_iris[[1]]): "double"

-   typeof(df_iris[[5]]): "integer"
