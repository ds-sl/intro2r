...
-   Responses to Week Five Assignment (in progress): [[Link](https://ds-sl.github.io/intro2r/da4r/w5a_response.nb.html)]. [[Rmd](https://github.com/ds-sl/intro2r/blob/main/docs/da4r/w5a_response.Rmd)]
...
-   R Notebook to MS PowerPoint with `reference_doc: ref-ppt-style.pptx`

-   R Notebook to PDF with `tinytex`

-   R Notebook to MS Word with `reference_doc: ref-doc-style.docx`
...
-   PDF: a little difficult unless you know LaTeX [[Link](https://bookdown.org/yihui/rmarkdown/pdf-document.html)]
